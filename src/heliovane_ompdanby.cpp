// October 23, 2023: heliovane_ompdanby.cpp:
// Like heliolinc_ompdanby and similar  programs to which it is closely
// related, heliovane_ompdanby searches for asteroids using hypotheses
...
int main(int argc, char *argv[])
{
  ...
  status=heliovane_alg_ompdanby(image_log, detvec, tracklets, trk2det, lambdahyp, earthpos, config, outclust, clust2det);
  if(status!=0) {
