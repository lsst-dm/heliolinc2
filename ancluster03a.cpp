...
int main(int argc, char *argv[])
{
  ...
  clusteran02 clustan = clusteran02("",0,0,0,0l,0,{},{},{},0l);
  vector <clusteran02> clustanvec;
  vector <clusteran02> clustanvec2;
  ...
  for(clusterct=0; clusterct<clusternum; clusterct++) {
	...
	getline(instream1,lnfromfile);
      ...
      // Define clusteran02 object, except for final clustind vector.
      clustan = clusteran02(clusternames[clusterct],accelct,clusternum2,ptnum,timespan,daysteps,rmsvec,heliopar,{},clustmetric);
